...
namespace SalesOrderFormProject
{
    public partial class frmKWSales : Form
    {
        ...
        {
            //--------------- For Order GroupBox -----------------------
            // Getting the file path to mdf file
            string fullFilePath = Path.GetFullPath("SQLKWSalesDB.mdf");

            //connect to sales database
            KWSalesConnection = new SqlConnection("Data Source=.\\SQLEXPRESS; AttachDbFilename=" + fullFilePath + "; Integrated Security=True; Connect Timeout=30; User Instance=True");
        ...
        private void frmKWSales_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (newCustomer)
            {
                MessageBox.Show("You must finish the current edit before stopping.",
                                "",
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            // rebind controlls to data table
